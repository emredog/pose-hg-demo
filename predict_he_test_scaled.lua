...
for file in lfs.dir[[/home/emredog/git/pose-hg-demo/images/he/test_256/]] do
...
for i = 1,nbSamples do
    -- Set up input image
    -- im0020_C1_256.jpg
    impath = 'images/he/test_256/' .. filelist[i-1]
...
-- Save predictions
local predFile = hdf5.open('preds/he_test_scaled.h5', 'w')
